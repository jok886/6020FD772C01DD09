...
namespace Crosstales.BWF.EditorIntegration
{
    ...
    public class BWFMenu
    {
        ...
        private static void AddBWF()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "Add " + Util.Constants.MANAGER_SCENE_OBJECT_NAME);
        }
        ...
        private static void ShowManual()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_MANUAL_URL");
        }
        ...
        private static void ShowAPI()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_API_URL");
        }
        ...
        private static void ShowForum()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_FORUM_URL");
        }
        ...
        private static void ShowProduct()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_WEB_URL");
        }
        ...
        private static void ShowVideoPromo()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_VIDEO_PROMO");
        }
        ...
        private static void ShowVideoTutorial()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_VIDEO_TUTORIAL");
        }
        ...
        private static void ShowAllVideos()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_SOCIAL_YOUTUBE");
        }
        ...
        private static void Show3rdPartyAV()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_3P_PLAYMAKER");
        }
        ...
        private static void ShowUAS()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_CT_URL");
        }
        ...
        private static void ShowCT()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "ASSET_AUTHOR_URL");
        }
        ...
        private static void ShowInfo()
        {
            ...
            GAApi.Event(typeof(BWFMenu).Name, "Info");
        }
    }
}
