    ...
    public abstract class ConfigBase : EditorWindow
    {
        ...
        protected void showConfiguration()
        {
            ...
            scrollPosConfig = EditorGUILayout.BeginScrollView(scrollPosConfig, false, false);
            {
                ...
                //Util.Constants.DONT_DESTROY_ON_LOAD = EditorGUILayout.Toggle(new GUIContent("Don't destroy on load", "Don't destroy BWF during scene switches (default: true, off is NOT RECOMMENDED!)."), Util.Config.DONT_DESTROY_ON_LOAD);
