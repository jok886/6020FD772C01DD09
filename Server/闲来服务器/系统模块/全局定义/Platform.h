...
//程序版本
#define VERSION_FRAME				PROCESS_VERSION(6,1,3)				//框架版本
#define VERSION_PLAZA				PROCESS_VERSION(9,1,3)				//大厅版本
#define VERSION_MOBILE_ANDROID		PROCESS_VERSION(6,1,3)				//手机版本
#define VERSION_MOBILE_IOS			PROCESS_VERSION(6,1,3)				//手机版本
...
//数据库名
const TCHAR szPlatformDB[]=TEXT("QPPlatformDB_HideSeek");						//平台数据库
const TCHAR szAccountsDB[]=TEXT("QPAccountsDB_HideSeek");						//用户数据库
const TCHAR	szTreasureDB[]=TEXT("QPTreasureDB_HideSeek");						//财富数据库
const TCHAR	szExerciseDB[]=TEXT("QPExerciseDB_HideSeek");						//练习数据库
