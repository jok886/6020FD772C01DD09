...
#define MAX_CONTENT					4096								//并发容量 mChen edit 512
#define PORT_AUTO_SELECT			INVALID_WORD						//自动端口

#define PORT_LOGON					10081								//登陆端口
#define PORT_CENTER					8311								//协调端口
#define PORT_MANAGER				8321								//管理端口
...
//长度定义
#define SOCKET_TCP_BUFFER			65530								//网络缓冲 16384 mChen edit, fix size bug: 因为TCPInfo.wPacketSize, ushort最大值为65535
