...
public:
	//
	virtual bool OnEventReqStandUP(IServerUserItem * pIServerUserItem, BYTE cbForceStandUP)=NULL;
...
public:
	...
	virtual void OnStopService() = NULL;
...
interface IPrivateEventSink :public IUnknownEx
{
	...
	//mChen add, for HideSeek
	virtual void RandomUserTeamTypeAndModelIndex(IServerUserItem * pIServerUserItem, BYTE cbMapIndexRand, BYTE cbChoosedMapIndex, bool bIsXuFang) = NULL;
	virtual void ForceDismissAndClearRoom(WORD wTableId) = NULL;
};
