...
public:
	...
	//数据库事件
	virtual bool OnEventDataBase(WORD wRequestID, DWORD dwContextID, VOID * pData, DWORD wDataSize);
...
protected:
	...
	//mChen add
	//查询代理人列表结果
	bool OnDBPCOSpreadersInfoResoult(DWORD dwContextID, VOID * pData, DWORD wDataSize);
	//mChen add
	//查询代理人列表结果
	bool OnDBPCOTopPlayersInfoResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//mChen add
	//内购
	bool OnDBPCOAddPaymentResult(DWORD dwContextID, VOID * pData, DWORD wDataSize);
	//名下用户交易信息
	bool OnDBPCOChildrenPaymentInfoResult(DWORD dwContextID, VOID * pData, DWORD wDataSize);
	//企业提现
	bool OnDBPCOAddEnterprisePaymentResult(DWORD dwContextID, VOID * pData, DWORD wDataSize);

	//mChen add, for HideSeek
	bool OnDBPCOBoughtTaggerModelResoult(DWORD dwContextID, VOID * pData, DWORD wDataSize);

	//查询昵称结果
	bool OnDBPCOQueryNickNameInfoResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//转房卡结果
	bool OnDBPCOTransferDiamondsResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
...
protected:
	...
	//mChen add
	bool OnDBPCUserRaffleResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	...
	//商品购买  WQ
	bool OnDBPCAddShopItemResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	bool OnDBPCExchangeScoreInfoResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
...
protected:
	...
	//mChen add
	bool OnTCPNetworkSubPCRaffleDone(WORD wSubCmdID, VOID * pData, WORD wDataSize, DWORD dwSocketID);
...
protected:
	...
	//mChen add. for HideSeek
	//发送大厅列表
	VOID SendGameLobbyInfo(DWORD dwSocketID);
