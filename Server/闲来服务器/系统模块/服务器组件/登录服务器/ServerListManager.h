...
namespace NServerListManager
{
	...
	typedef CMap<WORD, WORD, tagGameLobby *, tagGameLobby * &> CLobbyItemMap;
	...
	protected:
		...
		//mChen add. for HideSeek
		CLobbyItemMap					m_LobbyItemMap;						//大厅索引
	...
	public:
		...
		//mChen add, for HideSeek
		//插入大厅
		bool InsertGameLobby(tagGameLobby * pGameLobby);
	...
	public:
		...
		//mChen add, for HideSeek
		//删除大厅
		bool DeleteGameLobby(WORD wPlazaID);
	...
	public:
		...
		//mChen add, for HideSeek
		//枚举大厅
		tagGameLobby * EmunGameLobbyItem(POSITION & Position);
	...
	public:
		...
		//mChen add, for HideSeek
		//大厅数目
		DWORD GetGameLobbyCount() { return (DWORD)m_LobbyItemMap.GetCount(); }
	};
