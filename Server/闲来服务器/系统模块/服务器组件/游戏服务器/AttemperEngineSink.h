...
public:
	//发送数据
	virtual bool SendData(BYTE cbSendMask, WORD wMainCmdID, WORD wSubCmdID, VOID * pData, DWORD wDataSize);
	//发送数据
	virtual bool SendData(DWORD dwSocketID, WORD wMainCmdID, WORD wSubCmdID, VOID * pData, DWORD wDataSize);
	//发送数据
	virtual bool SendData(IServerUserItem * pIServerUserItem, WORD wMainCmdID, WORD wSubCmdID, VOID * pData, DWORD wDataSize);
	//群发数据
	virtual bool SendDataBatchToMobileUser(WORD wCmdTable, WORD wMainCmdID, WORD wSubCmdID, VOID * pData, DWORD wDataSize);
...
protected:
	...
	//WQ
	bool OnDBPCUserAwardResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	bool OnDBPCInventoryConsumptionResoult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//连接处理
protected:
	//注册事件
...
public:
	//执行奖励
	bool OnTCPNetworkSubPCAwardDone(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//道具消费
	bool OnTCPNetworkSubPCInventoryConsumption(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//银行命令
protected:
	//查询银行
