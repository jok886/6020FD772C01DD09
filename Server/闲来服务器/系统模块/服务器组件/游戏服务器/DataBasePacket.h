...
#define DBR_GR_MATCH_SIGNUP_CHECK   607									//报名查询 mChen add
#define DBR_GR_MATCH_RECORD_SCORE   608									//记录比赛积分 lin add
//游戏事件
...
#define DBR_GR_JOIN_FAILED				803				//加入私人房间失败

//mChen add,for代开房
#define DBR_GR_INSERT_PRIVSTE_ROOM		804	
#define DBR_GR_JOIN_CHECK				805				//加入房间判断，是否有足够钻石加入AA房间

//mChen add, for HideSeek
#define DBR_GR_CLEAR_GAME_SCORE_LOCKER	806				//删除锁表记录

//WQ
#define DBR_GR_AWARD_DONE               807
#define DBR_GR_INVENTORYCONSUMPTIONINFO        808                   //道具消费
...
#define DBO_GR_MATCH_SIGNUP_CHECK_RESULT      504						//报名查询结果 mChen add
...
#define DBO_GR_CHECK_JOIN_PRIVATE			703									//私人场信息	
...
struct DBO_GR_LogonSuccess
{
	...
	TCHAR							szHeadHttp[LEN_USER_NOTE];			//微信头像http地址
	DWORD							dwPlayCount;
	SYSTEMTIME                      RegisterDate;						//注册日期
