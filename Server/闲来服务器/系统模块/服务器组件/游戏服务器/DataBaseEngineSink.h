...
protected:
	//mChen add:报名查询
	bool OnRequestMatchSignupCheck(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	//比赛报名
	...
	//比赛积分
	bool OnRequestMatchRecordScore(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	//比赛淘汰
	bool OnRequestMatchEliminate(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);

	//私人场服务
protected:
	bool OnRequestJoinFailed(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	...
	//mChen add,for代开房
	bool OnRequestInsertPrivateRoom(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	bool OnRequestCheckJionPrivate(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	//mChen add, for HideSeek
	//删除锁表记录
	bool OnRequestClearGameScoreLocker(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
public:
	//执行奖励
	bool OnRequestaAwardDone(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	bool OnRequestInventoryConsumption(DWORD dwContextID, void* pData, WORD wDataSize);
