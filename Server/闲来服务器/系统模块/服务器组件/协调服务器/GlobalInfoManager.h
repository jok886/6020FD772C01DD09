...
typedef CMap<WORD, WORD, CGlobalLobbyItem *, CGlobalLobbyItem *> CMapLobbyID;
...
public:
	CMapUserID						m_MapUserID;						//用户索引
																		...
																		//链表属性
protected:
	CGlobalLobbyItem *				m_pNextLobbyItemPtr;				//对象指针
...
protected:
	...
	//mChen add, for HideSeek
	CGlobalLobbyItem *				m_pGlobalLobbyItem;					//大厅存储
...
public:
	...
	//mChen add, for HideSeek
	//大厅数目
	DWORD GetLobbyItemCount() { return (DWORD)m_MapLobbyID.GetCount(); }
...
public:
	//删除大厅
	bool DeleteLobbyItem(WORD wLobbyID);
	//激活大厅
	bool ActiveLobbyItem(WORD wBindIndex, tagGameLobby & GameLobby);
...
private:
	...
	//mChen add, for HideSeek
	//创建大厅
	CGlobalLobbyItem * CreateGlobalLobbyItem();
...
private:
	...
	//mChen add, for HideSeek
	//释放大厅
	bool FreeGlobalLobbyItem(CGlobalLobbyItem * pGlobalLobbyItem);
};
