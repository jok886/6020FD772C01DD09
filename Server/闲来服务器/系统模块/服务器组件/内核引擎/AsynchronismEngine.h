...
public:
	...
	//插入请求
	virtual bool  InsertRequest(WORD wRequestID, void * const pBuffer, DWORD wDataSize, IUnknownEx * pIUnknownEx);
...
public:
	...
	//投递数据
	virtual bool  PostAsynchronismData(WORD wIdentifier, VOID * pData, DWORD wDataSize);
	//取消注册
