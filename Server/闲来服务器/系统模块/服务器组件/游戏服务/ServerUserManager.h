...
public:
	...
	virtual BYTE GetLastUserStatus() { return m_UserInfo.cbLastUserStatus; }
...
public:
	...
	virtual bool SetPlayerTeamType(PlayerTeamType eTeamType);
	virtual bool SetModelIndex(BYTE cbModelIndex);
	virtual bool SetChoosedModelIndexOfTagger(BYTE cbChoosedModelIndexOfTagger);
