...
public:
	//插入数据
	bool InsertData(WORD wIdentifier, VOID * pBuffer, DWORD wDataSize);//mChen edit WORD, fix size bug
	//插入数据
	bool InsertData(WORD wIdentifier, tagDataBuffer DataBuffer[], DWORD wDataCount);//mChen edit WORD, fix size bug
...
public:
	...
	//提取数据
	bool DistillData(tagDataHead & DataHead, VOID * pBuffer, DWORD wBufferSize);//mChen edit WORD, fix size bug
