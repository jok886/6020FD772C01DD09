...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("HNMJ.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("HNMJServer-zz.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));//mChen HNMJServer.DLL HNMJServer-zz.DLL HNMJServer-sd.DLL
