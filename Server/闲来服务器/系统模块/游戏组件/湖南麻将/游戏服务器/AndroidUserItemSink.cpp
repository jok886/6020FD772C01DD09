...
bool CAndroidUserItemSink::OnSubSendCard( const void *pBuffer,WORD wDataSize )
{
	...
	//发牌处理
	if (pSendCard->cbSendCardData !=0)
	{
		m_cbCardIndex[pSendCard->wCurrentUser][m_GameLogic.SwitchToCardIndex(pSendCard->cbSendCardData)]++;
		//扣除扑克
		m_cbLeftCardCount--;
	}
	...
	if( wMeChairID == m_wCurrentUser )
	{
		...
		m_cbActionCard = pSendCard->cbSendCardData;
