...
CREATE PROC GSP_GR_MatchOver
	...
	@strErrorDescribe NVARCHAR(127) OUTPUT		-- 输出信息, mChen add
WITH ENCRYPTION AS
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			--mChen add
			SET @strErrorDescribe = N'RankCount='+convert(char(8),@RankCount)
	...
	BEGIN
		...
		WHERE MatchID=@dwMatchID AND MatchNo=@dwMatchID
