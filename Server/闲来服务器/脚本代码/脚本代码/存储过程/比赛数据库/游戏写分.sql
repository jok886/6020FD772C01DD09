...
--	IF @cbTaskForward=1
--	BEGIN
--		exec QPPlatformDB_HideSeekLink.QPPlatformDB_HideSeek.dbo.GSP_GR_TaskForward @dwUserID,@wKindID,0,@lVariationWinCount,@lVariationLostCount,@lVariationDrawCount	
--	END
