...
--	END
	...
	SELECT @UserID AS UserID, @GameID AS GameID, @GroupID AS GroupID, @NickName AS NickName, @UnderWrite AS UnderWrite,  @FaceID AS FaceID,
		...
		@MasterOrder AS MasterOrder, @MemberOrder AS MemberOrder, @Score AS Score, 0 AS MatchScore, 0 AS Grade, @Insure AS Insure,  @WinCount AS WinCount,  @LostCount AS LostCount,
