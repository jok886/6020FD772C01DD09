...
BEGIN  
  ...
  FROM RecordInsure t1, QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo t2, QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo t3
