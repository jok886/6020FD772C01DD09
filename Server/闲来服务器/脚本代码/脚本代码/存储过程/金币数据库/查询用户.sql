...
BEGIN
	...
	IF @cbByNickName=1
		SELECT @TargetGameID=GameID, @NickName=NickName FROM QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo WHERE NickName=@strNickName
	ELSE
		SELECT @TargetGameID=GameID, @NickName=NickName FROM QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo WHERE GameID=@strNickName
