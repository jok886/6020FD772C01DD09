...
BEGIN
	...
	SELECT @UserID=UserID, @GameID=GameID, @NickName=NickName, @RegisterDate=RegisterDate, @UnderWrite=UnderWrite, @LogonPass=LogonPass, @FaceID=FaceID, @CustomID=CustomID,
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				SET @strErrorDescribe=N'当前网络不稳定，请稍后再试！'
