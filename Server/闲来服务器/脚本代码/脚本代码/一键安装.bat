...
osql -E -i "%rootPath%3_1_代理库脚本.sql"
...
osql -E -i "%rootPath%测试账号.sql"	Rem mChen
osql -E -i "%rootPath%代理设置.sql"
...
osql -E  -i "%rootPath%抽奖管理.sql"
osql -E  -i "%rootPath%转房卡.sql"
osql -E  -i "%rootPath%邮箱管理.sql"
...
osql -E  -i "%rootPath%充值代理提成.sql"
osql -E  -i "%rootPath%商店购买管理.sql"
