...
BEGIN
	...
	-- 更新会员
	UPDATE QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsMember SET MemberOverDate=MemberOverDate+@MemberDays
	...
	FROM QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsMember WHERE UserID=@UserID
	...
	SELECT @UserID=UserID,@Accounts=Accounts,@SpreaderID=SpreaderID FROM QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo
	WHERE UserID = @UserID
	IF @SpreaderID<>0
	BEGIN
