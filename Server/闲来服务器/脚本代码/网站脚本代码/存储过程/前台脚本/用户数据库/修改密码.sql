...
BEGIN
	...
	-- 添加记录
	INSERT INTO QPRecordDB_HideSeek.dbo.RecordPasswdExpend(OperMasterID,UserID,ReLogonPasswd,ReInsurePasswd,ClientIP,CollectDate)
...
BEGIN
	...
	-- 设置信息	
	SET @strErrorDescribe= N'恭喜您，您的银行密码修改成功了！'
