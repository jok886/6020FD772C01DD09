...
BEGIN
	...
	-- 查询金币
	SELECT @InsureScore = InsureScore FROM QPTreasureDB_HideSeekLink.QPTreasureDB_HideSeek.dbo.GameScoreInfo 
	...
	-- 兑换记录
	INSERT INTO QPRecordDB_HideSeekLink.QPRecordDB_HideSeek.dbo.RecordConvertUserMedal(
	...
	UPDATE QPTreasureDB_HideSeekLink.QPTreasureDB_HideSeek.dbo.GameScoreInfo SET
		InsureScore = InsureScore+@ConvertGold
	WHERE UserID = @dwUserID

	IF @@ROWCOUNT = 0 
	BEGIN
		INSERT INTO QPTreasureDB_HideSeekLink.QPTreasureDB_HideSeek.dbo.GameScoreInfo(UserID,InsureScore,RegisterIP,LastLogonIP)
