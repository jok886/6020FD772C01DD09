...
BEGIN
	...
	-- 获取用户经验
	SELECT @CurExperience = Experience FROM QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo
	WHERE UserID = @UserID
	...
	-- 赠送经验
	UPDATE QPAccountsDB_HideSeekLink.QPAccountsDB_HideSeek.dbo.AccountsInfo SET Experience = Experience + @AddExperience
	WHERE UserID = @UserID
END
RETURN 0
