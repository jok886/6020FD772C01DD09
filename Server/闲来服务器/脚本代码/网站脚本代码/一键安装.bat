...
osql -d QPAccountsDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPGameMatchDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPGameScoreDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPNativeWebDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPPlatformDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPPlatformManagerDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPRecordDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
osql -d QPTreasureDB_HideSeek -E  -n -i "%rootPath%分页过程.sql"
